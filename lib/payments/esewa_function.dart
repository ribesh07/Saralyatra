...
import 'package:saralyatra/pages/tickets/generate_ticket.dart';
...
class Esewa {
  ...
  Future<void> addDetails(
    ...
    String uniqueId = '$userID${DateTime.now().millisecondsSinceEpoch}';
    ...
    try {
      await documentReference.set(historyData);
      print(
          'History data added to the database successfully at: ${documentReference.path}');
    } catch (e) {
      print('Error adding history data to the database: $e');
    }
  }
